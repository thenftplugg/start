    ...
    <div className="navbar-sidebar">
      ...
      >
        <div className="navbar-sidebar__item menu">
          ...
          <a href="https://crypticalpha.io/app" target="_blank" rel="noopener noreferrer">
            <p className={styles.zoraCoText}>OPEN APP -&gt; </p>
          </a>
          <a
            href="https://github.com/crypticalphaio"
            target="_blank"
        ...
        {!mobileSidebar.shouldRender && (
          <>
            <div className="navbar__items navbar__items--right">
              ...
              <a href="https://crypticalpha.io/app" target="_blank" rel="noopener noreferrer">
                <button className={styles.zoraCoButton}>OPEN APP -&gt;</button>
              </a>
            </div>
          </>
        )}
